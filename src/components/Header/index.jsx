...
function Header(props) {
  ...
  return (
    <div className={styles.container}>
      <div className={classNames(className || "", 'mac-book-pro-16-4-2', styles.root)}>
          <div
            onClick={() => router.push("/")}
            ref={logoContainerRef}
            role="img"
            aria-describedby="The Debt Relief Co Logo."
            className={classNames('logo-debt-relief-1-1', 'cursor-pointer', styles.logo)}
          />
          <div className={styles.frame12}>
            ...
            <button className={classNames(styles.frame4, 'grow')} onClick={() => router.push('/book-online')}>
              <div className={styles.bookAConsultation}>
                <span>Book a consultation</span>
              </div>
            </button>
          </div>
          <Image onClick={handleMenuClick} className={styles.toggle} src={isMenuOpen ? "/static/img/tabler-menu-2-1@2x.svg" : '/static/img/tabler-menu-2-2@2x.svg'} alt="tabler:menu-2"  width={40} height={40}/>
