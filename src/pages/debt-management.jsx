      ...
      <main>
        ...
        <div className="mt-[86px] -mb-8 overflow-hidden flex flex-col px-6 md:px-24">
          ...
          <Container className="text-left text-gray-700 flex-col flex bg-white h-auto mt-12 ">
            <span className="text-4xl sm:text-3xl w-full text-gray-600 font-semibold">
        ...
        {/* section 2 */}
          ...
          >
            <Container className="flex flex-col gap-6">
              <h1 className="text-3xl mt-4 w-full text-main_text font-semibold text-center">How Debt Management Programs Work</h1>
              <p>
...
​              </p>
          ...
          >
            <Container className="flex flex-col gap-6">
              <h1 className="text-3xl mt-4 w-full text-main_text font-semibold text-center">Implications of a DMP</h1>
              <p>
...
​              </p>
          ...
          >
            <Container className="flex flex-col gap-6">
              <h1 className="text-3xl mt-4 w-full text-main_text font-semibold text-center">Are Debt Management Plans a Recommended Debt Relief Option?</h1>
              <p>
