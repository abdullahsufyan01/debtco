      ...
      <main>
        ...
        <div className="mt-[86px] -mb-8 relative overflow-hidden flex flex-col w-screen prose">
          ...
          <Container className="text-center text-gray-700 flex-col flex w-full sm:w-2/3 mt-12 px-4 sm:px-0">
            <span className="text-4xl sm:text-5xl w-full text-gray-600 font-semibold">
              Debt Collections
            </span>
            <span className="mt-4 text-xl font-semibold text-gray-500 mb-6">
          ...
          >
            <Container className="flex flex-col gap-6">
              <h1 className="text-3xl mt-4 w-full text-main_text font-semibold text-center">How Do Collection Agencies Buy Your Debt?</h1>
              <p>
          ...
          >
            <Container className="flex flex-col gap-6">
              <h1 className="text-3xl mt-4 w-full text-main_text font-semibold text-center">FDCPA - Debt Collection Guidelines</h1>
              <p>
          ...
          >
            <Container className="flex flex-col gap-6">
            <h1 className="text-3xl mt-4 w-full text-main_text font-semibold text-center">What Should You Do If You&apos;re Getting Harassed?</h1>
              <p>
